    ...
    <section className="border-t border-stone-200">
      <div className="max-w-6xl mx-auto px-6 py-24 grid gap-14 md:grid-cols-[1fr_1fr] md:items-start">
        <SectionHeading
          ...
          body="Pulseui takes the moments every AI product already has and renders them with physical metaphors — particles, liquid, swarms, film — in the spirit of rareui and Aceternity, but themed around AI states instead of generic marketing UI."
        />
